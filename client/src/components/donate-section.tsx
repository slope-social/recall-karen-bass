      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[3vmin]">
        <Card>
          <CardContent className="p-[3vmin]">
            ...
            <p className="text-[2vmin] text-muted-foreground mb-[3vmin]">
              Your contribution helps support our mission. Make a secure donation through our trusted platform.
            </p>
            <Button 
              className="w-full flex items-center justify-center gap-[1vmin] text-[2vmin]"
              asChild
            >
              <a 
              ...
              >
                Donate Now <ExternalLink className="h-[2vmin] w-[2vmin]" />
              </a>
            </Button>
          </CardContent>
        </Card>
